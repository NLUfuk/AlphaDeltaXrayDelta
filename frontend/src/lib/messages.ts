...
const ERRORS: Record<string, string> = {
  ...
  'setting.invalid_int': 'Bu ayar pozitif bir tam sayı olmalı (birim yazmayın, ör. 10).',
  'setting.invalid_json': 'Bu ayar JSON metin dizisi olmalı, ör. ["image/png","application/pdf"].',
  'setting.invalid_color': 'Bu ayar #rrggbb biçiminde bir renk olmalı, ör. #2563eb.',
